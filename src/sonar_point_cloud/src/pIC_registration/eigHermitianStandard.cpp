...
namespace coder {
void eigHermitianStandard(const array<double, 2U> &A, array<creal_T, 2U> &V,
                          array<creal_T, 2U> &D)
{
  array<double, 2U> b_A;
  array<double, 1U> W;
